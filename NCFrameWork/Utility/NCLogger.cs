...
namespace DI.NCFrameWork
{
	...
	{		
        ...
        //************************************************************************
        /// <summary>
        /// ログタイプ 1:各ユーザ別ログを管理する、0:すべてのユーザは同じログを管理する
        /// </summary>
        //************************************************************************
		...
		#region msgを"Information"levelでログファイルに出力する
		//************************************************************************
		/// <summary>
		/// void Write(string msg)
		/// </summary>
		/// <remarks>
		/// msgを"Information"levelでログファイルに出力する
		/// </remarks>
		...
		private void GetLogConfig(ref string strLogPath, ref string strLogFile, ref string strFileExt, ref int iLogCount, ref int iLogSize, ref int iLogLevel)
		{
			try
			{
                ...
                if (config != null)
                {
                    ...
                    // ログファイル格納するパスは指定していない場合は、該当アプリ下のLogというフォルダを設定する
